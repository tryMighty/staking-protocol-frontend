    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mb-12 text-center animate-pulse">
          <h1 className="font-headline text-5xl font-black text-white tracking-[0.3em] uppercase drop-shadow-[0_0_20px_rgba(57,255,106,0.5)]">
            Celestial
          </h1>
          <p className="text-primary text-xs mt-4 tracking-[0.5em] uppercase font-bold opacity-80">
            Initializing Secure Terminal
          </p>
        </div>

        {/* Progress Container */}
        <div className="w-64 h-1 bg-white/5 rounded-full overflow-hidden relative glass-item p-0 border-none">
          <div 
        ...
        <div className="mt-6 flex flex-col items-center gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono text-primary/70 uppercase tracking-widest">
              ...
              {progress >= 30 && progress < 60 && "Establishing uplink to blockchain..."}
              {progress >= 60 && progress < 90 && "Calibrating terminal aesthetics..."}
              {progress >= 90 && "Ready for deployment."}
            </span>
          </div>
          <span className="font-mono text-[10px] text-white/40">{progress}% COMPLETE</span>
        </div>
      </div>
